...
namespace SRRSBakery.Migrations
{
    ...
    [Migration("20220823111546_imageupdatess")]
    partial class imageupdatess
    {
            ...
            modelBuilder.Entity("SRRSBakery.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CategoryName = "Breads",
                            Description = "Breads",
                            ImgUrl = "https://c4.wallpaperflare.com/wallpaper/560/812/59/bread-different-sliced-white-bread-wallpaper-preview.jpg"
                        },
                        new
                        {
                            CategoryId = 7,
            ...
            modelBuilder.Entity("SRRSBakery.Models.ImageExtra", b =>
                {
                    b.HasOne("SRRSBakery.Models.Item", "item")
                        .WithOne("ImageExtra")
                        .HasForeignKey("SRRSBakery.Models.ImageExtra", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
